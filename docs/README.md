...
- 대상 버전: `0.4.17`
- 현재 단계: `0.4.17` 복구형 패치 구현, 자동 검증, 패키징, GitHub Release 공개 게시 완료. 수동 QA sign-off 전
- 자동 검증 기록: `2026-06-08` 전체 테스트 `127 files / 554 tests`, 승인 범위 타깃 테스트 `13 files / 59 tests`, 빌드, 구조 검증, `release:publish`, packaged/installer smoke 통과
