...
- 대상 버전: `0.4.8`
- 현재 단계: `0.4.8` 패치 구현 및 자동 검증 완료, GitHub Release 게시 준비 완료
- 자동 검증 마지막 재확인: `2026-04-30`
- 최근 반영 변경: `2026-04-30` 패치이력 게시판 전환, 업데이트 패치노트 마침 버튼, 실행 시 최대화 표시, 근무표 Calendar 날짜 서식 보정, 0.4.8 릴리즈 게시
...
## 문서 용도
- `release-0.4.8.md`: 현재 릴리즈 상태, 배포 결과, 남은 수동 확인 기준
...
3. `artifacts/releases/v0.4.8/README.md`
4. `release-0.4.8.md`
