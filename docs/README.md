...
- 현재 단계: `0.4.0` 핵심 자동 검증 완료, installer 재검증은 로컬 Windows Application Control 정책으로 차단, 운영 데이터 수동 QA / sign-off 대기
- 자동 검증 마지막 재확인: `2026-04-18`
- 최근 반영 변경: `2026-04-18` `release-0.4.0.md` active release 문서 생성, `v0.4.0` 릴리즈 아카이브 / sign-off 템플릿 정리
