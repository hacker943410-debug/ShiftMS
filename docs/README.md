...
- 대상 버전: `0.4.9`
- 현재 단계: `0.4.9` 계정복구 패치 구현 및 자동 검증 완료
- 자동 검증 마지막 재확인: `2026-05-07`
- 최근 반영 변경: `2026-05-07` 로그인 화면 계정복구, 운영 관리 복구키 발급, 복구 전 DB 백업, 유지보수 admin 재설정 스크립트 추가
...
## 문서 용도
- `release-0.4.9.md`: 현재 릴리즈 상태, 계정복구 기준, 남은 수동 확인 기준
...
3. `artifacts/releases/v0.4.9/README.md`
4. `release-0.4.9.md`
