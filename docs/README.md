...
- 대상 버전: `0.4.10`
- 현재 단계: `0.4.10` 실적 파싱 안정화 패치 및 설치본 배포 준비
- 자동 검증 마지막 재확인: `2026-05-07`
- 최근 반영 변경: `2026-05-07` 승인대기 실적 조회 안정화, 파싱 진행률/규격 오류 내부모달, 기존 설치본 복구키 발급 스크립트 추가
...
## 문서 용도
- `release-0.4.10.md`: 현재 릴리즈 상태, 실적 파싱 안정화 기준, 남은 수동 확인 기준
...
3. `artifacts/releases/v0.4.10/README.md`
4. `release-0.4.10.md`
