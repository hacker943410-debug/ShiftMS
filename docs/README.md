...
- 대상 버전: `0.4.27`
- 현재 단계: `0.4.27` 실적관리 조별 검수·반려 재파싱·None 취소 처리 안정화 GitHub Release 게시 완료
- 자동 검증 기록: `2026-06-13` 전체 테스트 `130 files / 635 tests`, 타입체크 포함 빌드, release publish, packaged/installer smoke 통과
