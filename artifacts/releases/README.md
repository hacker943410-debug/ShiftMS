...
| 버전 | 기준일 | 상태 | 비고 |
|---|---|---|---|
| `v0.4.21` | `2026-06-11` | 구현 및 자동 검증 완료 / 패키징 전 | 치환 슬롯 dutyCode 시간 fallback, 대체근무 empty-marker 파싱, 품의서 선지급 병합 충돌 방지 |
| `v0.4.20` | `2026-06-11` | 구현 및 자동 검증 완료 / 패키징 전 | 월간 근무표 자동 복구, 출처 기준 재승인, 승인 스냅샷 보정 |
