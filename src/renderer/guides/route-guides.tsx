  ...
  pages: [
    {
      ...
      steps: [
        ...
        {
          title: "차트로 원인 압축",
          description: "월별 추이, 근무지 편차, 유형 비율을 비교해 이상치가 어디에서 시작됐는지 좁힙니다."
        },
        {
          title: "현재 화면 기준 내보내기",
      ...
      detailItems: [
        ...
        {
          title: "차트 분석 영역",
          description: "추이 차트와 분포/비율 카드로 시점, 근무지, 유형 관점의 편차를 같이 해석합니다."
        },
        {
          title: "내보내기 액션",
          description: "현재 화면 상태를 그대로 문서화할 때 사용하는 마지막 단계이며, 보고용 PDF와 가공용 Excel을 구분해 사용합니다."
        }
      ],
      notes: [
    ...
    },
    {
      ...
      steps: [
        ...
        {
          title: "차트 분석",
          description: "월별 추이, 근무지별 현황, 유형 비율을 비교해 편차 원인을 찾습니다."
        },
        {
          title: "문서 내보내기",
    ...
    },
    {
      ...
      description:
        "대시보드 본문은 KPI 카드, 월별 추이, 근무지 비교, 유형 비율 순서로 보면 한 번에 원인을 좁히기 쉽도록 구성돼 있습니다.",
      ...
      steps: [
        ...
        {
          title: "근무지 및 유형 비율로 원인 압축",
          description: "특정 근무지 문제인지, 연장·대체·휴일 중 어떤 유형이 커졌는지 이어서 확인합니다."
        }
      ],
      detailItems: [
        {
        ...
        {
          title: "유형 비율 카드",
          description: "연장, 대체, 휴일 중 어떤 유형 비중이 커졌는지 확인해 원인을 더 좁힙니다."
        }
      ],
      notes: [
    ...
    },
    {
      ...
      description:
        "대시보드 우측 상단 내보내기 버튼은 현재 보이는 집계 상태를 그대로 PDF 또는 Excel로 저장합니다.",
      ...
      detailItems: [
        ...
        {
          title: "내보내기 버튼 선택",
          description: "보고서 공유는 PDF, 추가 가공은 Excel로 나눠 사용합니다. 버튼 선택 순간 현재 화면 기준이 그대로 반영됩니다."
        },
        {
          title: "저장 완료 확인",
  ...
  pages: [
    {
      ...
      figure: <WorkforceGuideScene variant="overview" />
    },
    {
      id: "workforce-toc",
      kind: "toc",
      ...
      figure: <WorkforceGuideScene variant="toc" />
    },
    {
      ...
      figure: <WorkforceGuideScene variant="filters" />
    },
    {
      id: "workforce-create",
      kind: "feature",
      ...
      figure: <WorkforceGuideScene variant="create" />
    },
    {
      id: "workforce-detail",
      kind: "feature",
      ...
      figure: <WorkforceGuideScene variant="detail" />
    },
    {
      ...
      figure: <WorkforceGuideScene variant="wage-bulk" />
    }
  ]
};
...
export const workforceWageBulkGuide: RouteGuideDefinition = {
  ...
  pages: [
    ...
    },
    {
      ...
      figure: <WorkforceGuideScene variant="wage-bulk-toc" />
    },
    {
      ...
      figure: <WorkforceGuideScene variant="wage-bulk-sheet" />
    },
    {
      ...
      figure: <WorkforceGuideScene variant="wage-bulk-preview" />
    }
  ]
};
  ...
  pages: [
    {
      ...
      figure: <SiteGuideScene variant="overview" />
    },
    {
      id: "sites-toc",
      kind: "toc",
      ...
      figure: <SiteGuideScene variant="toc" />
    },
    {
      id: "sites-list",
      kind: "feature",
      ...
      figure: <SiteGuideScene variant="list" />
    },
    {
      id: "sites-step1",
      kind: "feature",
      ...
      figure: <SiteGuideScene variant="step1" />
    },
    {
      id: "sites-step2",
      kind: "feature",
      ...
      figure: <SiteGuideScene variant="step2" />
    },
    {
      id: "sites-detail",
      kind: "feature",
      ...
      figure: <SiteGuideScene variant="detail" />
    },
    {
      ...
      figure: <SiteGuideScene variant="pattern-import" />
    }
  ]
};
...
export const sitePatternImportGuide: RouteGuideDefinition = {
  ...
  pages: [
    ...
    },
    {
      ...
      figure: <SiteGuideScene variant="pattern-import-toc" />
    },
    {
      ...
      figure: <SiteGuideScene variant="pattern-import-sheet" />
    },
    {
      ...
      figure: <SiteGuideScene variant="pattern-import-preview" />
    }
  ]
};
  ...
  pages: [
    {
      ...
      figure: <AllowanceGuideScene variant="proposal" />
    },
    {
  ...
  pages: [
    {
      ...
      renderFigure: ({ activeFocusIndex, activeTab }) => (
        <OperationsGuideScene activeFocusIndex={activeFocusIndex} activeTab={activeTab} variant="overview" />
      )
    },
    {
      id: "operations-toc",
    ...
    },
    {
      ...
      renderFigure: ({ activeFocusIndex, activeTab }) => (
        <OperationsGuideScene activeFocusIndex={activeFocusIndex} activeTab={activeTab} variant="settings" />
      )
    },
    {
      ...
      renderFigure: ({ activeFocusIndex, activeTab }) => (
        <OperationsGuideScene activeFocusIndex={activeFocusIndex} activeTab={activeTab} variant="holiday-rate" />
      )
    },
    {
      id: "operations-user",
      ...
      renderFigure: ({ activeFocusIndex, activeTab }) => (
        <OperationsGuideScene activeFocusIndex={activeFocusIndex} activeTab={activeTab} variant="user" />
      )
    },
    {
      ...
      renderFigure: ({ activeFocusIndex, activeTab }) => (
        <OperationsGuideScene activeFocusIndex={activeFocusIndex} activeTab={activeTab} variant="template" />
      )
    },
    {
      ...
      kind: "feature",
      navLabel: "DB업데이트",
      title: "백업 경로를 확인하고 DB업데이트를 실행해 결과를 기록합니다.",
      description:
        "상단 DB업데이트 버튼으로 미리보기를 열고, 이관 건수와 백업 경로를 확인한 뒤 실제 업데이트를 실행합니다.",
      goal: "DB업데이트 전에 백업 경로가 정상 연결되어 있는지 반드시 확인합니다.",
      steps: [
        {
          title: "백업 경로 확인",
          description: "백업 경로가 정상 연결된 드라이브를 가리키고 있는지 확인합니다."
        },
        {
          title: "DB업데이트 실행",
          description: "업데이트 버튼을 눌러 실행합니다. 처리 중에는 다른 작업을 하지 않습니다."
        },
        {
          title: "결과 확인",
          description: "업데이트 완료 메시지와 마지막 업데이트 시각을 확인합니다."
        }
      ],
      notes: [
      ...
      detailItems: [
        ...
        {
          title: "미리보기 요약 영역",
          description: "이관 건수, 대상 경로, 경고 여부를 실행 전에 한 번 더 검토합니다."
        },
        {
          title: "업데이트 실행 버튼",
          description: "승인 후 실제 DB 교체와 결과 기록을 실행하는 마지막 버튼입니다."
        }
      ],
      renderFigure: ({ activeFocusIndex, activeTab }) => (
        <OperationsGuideScene activeFocusIndex={activeFocusIndex} activeTab={activeTab} variant="db-update" />
      )
    }
  ]
};
  ...
  pages: [
    {
      ...
      figure: <OperationsGuideScene variant="template" />
    },
    {
  ...
  pages: [
    {
      ...
      steps: [
        ...
        {
          title: "미리보기 확인",
          description: "현황 비교, 이관 상세, 경고를 먼저 읽습니다.",
          focusIndex: 1
        },
        {
          title: "실제 업데이트 실행",
      ...
      figure: <OperationsGuideScene variant="db-update" />
    },
    {
    ...
    },
    {
      ...
      steps: [
        ...
        {
          title: "운영 기준 재확인",
          description: "필요하면 경로 설정 탭으로 돌아가 마지막 업데이트 기준을 다시 확인합니다.",
          focusIndex: 2
        }
      ],
