...
export const accessLogActionLabels = {
  ...
  "app-update-download": "업데이트 다운로드",
  "app-update-install": "업데이트 적용",
  "release-notes-view": "패치노트 확인",
  "dashboard-export": "대시보드 출력",
  "employee-save": "인력 저장",
  "employee-rehire": "인력 재입사",
  "employee-retirement-correct": "퇴사일 정정",
  "employee-delete": "인력 삭제",
  "employee-wage-save": "시급 저장",
  "employee-wage-correct": "시급 정정",
  "employee-wage-delete": "시급 삭제",
  "employee-wage-close": "시급 종료",
  "employee-assignment-save": "배정 저장",
  "employee-assignment-close": "배정 종료",
  "employee-assignment-reorder": "배정 순서 변경",
